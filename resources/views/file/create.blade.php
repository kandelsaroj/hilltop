                  ...
                  <div class="card-content collapse show">
                    <div class="card-body">
                      ...
                      @endif
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="basicInputFile">Preview File</label> <br>
                                 <a href="{{url('uploads/file/'.$file->file_link)}}" target="_blank">{{$files->file_link}}</a>
                            </div>
                            @else
                            <div class="form-group col-md-6">
                        ...
                        <a type="button" id="" class="btn btn-danger mr-1" href="{{url('file')}}" role="button">
